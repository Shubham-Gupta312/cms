    ...
    $(document).ready(function () {
        ...
        jQuery(document).ready(function (e) {
            $('#addGallery').bootstrapValidator({
                ...
                $.ajax({
                    url: "<?= base_url('admin/homeGallery') ?>",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
        ...
        var table = $('#GalleryTable').DataTable({
            ...
            ajax: {
                url: "<?= base_url('admin/fetchGalleryImage') ?>",
                type: "GET",
        ...
        $(document).on('click', '.statusBtn', function (e) {
            ...
            $.ajax({
                method: "POST",
                url: "<?= base_url('admin/homeGalleryStatus') ?>",
                data: {
                    'id': galleryImageId
                },
                success: function (response) {
        ...
        $(document).on('click', '#editBanner', function (e) {
            ...
            $.ajax({
                method: "POST",
                url: "<?= base_url('admin/editGalleryImage') ?>",
                data: {
                    'id': galleryImageId
                },
                success: function (response) {
        ...
        $(document).on('click', '#updatebtn', function (e) {
            ...
            $.ajax({
                method: "POST",
                url: "<?= base_url('admin/updateGalleryImage') ?>",
                data: formData,
                processData: false,
                contentType: false,
                success: function (response) {
        ...
        $(document).on('click', '#deleteBanner', function(e){
            ...
            $.ajax({
                method: "POST",
                url: "<?= base_url('admin/deleteImageGallery') ?>",
